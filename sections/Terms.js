  ...
  <section className="mx-auto my-8">
    <div className="container px-4 py-8">
      ...
      <ul className="list-disc mt-2 ml-8">
        ...
        <li>
          <p>
            <strong>Country</strong> refers to:  Montenegro
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Joel Baker Ministry.
          </p>
        </li>
        <li>
          <p>
      ...
      <p className="mt-2">
        If you have any questions about these Terms and Conditions, You can contact us by email: <a href="mailto:bakersjn@hotmail.com" className="text-indigo-900">bakersjn@hotmail.com</a>
      </p>
    </div>
  </section>
);
